...
# --- BEGIN_HEADER ---
#
# xsimple - simple example xfunction application inserting and reading tuples
...
"""Simple example PastSet Xfunction application inserting and reading
tuples"""

import pastset

pset = pastset.PastSet()
test = pset.enter(('Test', int, float, str), 'xtest')
test.move((42, 3.14, 'Test'))
